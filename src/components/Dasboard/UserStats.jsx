  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div className="column center score-box" style={{ width: "20%", height:"25vh", margin:"25px" }}>
          <h3>QUIZZ DONE</h3>
          <img
            alt="r"
        ...
        <div className="column center score-box" style={{ width: "25%", height:"30vh", margin:"25px", backgroundColor:"var(--red)" }}>
